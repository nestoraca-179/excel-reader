...
from controller.DataController import validar_coincidencias, validar_coincidencias_avanzado, validar_coincidencias_inverso, validar_coincidencias_inverso
from controller.ExcelController import *
from models.AdmDTO import AdmDto
from models.ConDTO import ConDto

EXCEL_FILE_PATH = r"/home/developer/sources/AC/python/excel-reader/2022_test.xlsx"  # ← **ESPECIFICA TU RUTA AQUÍ**
EXCEL_FILE_RESULT_ADM_PATH = r"/home/developer/sources/AC/python/excel-reader/2022_test_result_adm.xlsx"  # ← **ESPECIFICA TU RUTA AQUÍ**
EXCEL_FILE_RESULT_CON_PATH = r"/home/developer/sources/AC/python/excel-reader/2022_test_result_con.xlsx"  # ← **ESPECIFICA TU RUTA AQUÍ**
